  ...
  public:
	...
	*/
	...
	/*!	
		...
		\sa		 print
	*/
    virtual char* evaluateAlphaNumeric()
	{
		return new char[1];
	}
...
*/
class ConcatNode : public AlphaNumericOperatorNode 
{
  public:
/*!		
...
*/
  ConcatNode(ExpNode *L, ExpNode *R) : AlphaNumericOperatorNode(L,R) 
  {
		// Empty
  }
...
/*!	
  ...
  \note    BuiltinFunctionNode_1 Class publicly inherits from BuiltinFunctionNode class 
		   and adds its own print and evaluate functions
*/
class BuiltinFunctionStringNode_1: public BuiltinFunctionNode 
{
  private:
	ExpNode *_exp;  //!< Argument of the BuiltinFunctionNode_1
  ...
  public:
/*!		
	\brief Constructor of BuiltinFunctionStringNode_1 uses BuiltinFunctionNode's constructor as member initializer
	\param id: string, name of the BuiltinFunction
	\param expression: pointer to ExpNode, argument of the BuiltinFunctionNode_1
	\post  A new BuiltinFunctionStringNode_1 is created with the parameters
*/
  BuiltinFunctionStringNode_1(std::string id, ExpNode *expression): BuiltinFunctionNode(id)
	{
		this->_exp = expression;
	}
	...
	*/
	...
	/*!
		\brief   Print the BuiltinFunctionStringNode_1
		\return  void
		\sa		 evaluate()
	*/
	  void print();
...
/*!	
  ...
  \note    BuiltinFunctionNode_2 Class publicly inherits from BuiltinFunctionNode class 
		   and adds its own print and evaluate functions
*/
class BuiltinFunctionStringNode_2 : public BuiltinFunctionNode 
{
	private:
		ExpNode *_exp1; //!< First argument of the BuiltinFunction_2
		ExpNode *_exp2; //!< Second argument of the BuiltinFunction_2
	...
	/*!		
		...
		\post  A new BuiltinFunctionNode_2 is created with the parameters
	*/
	  BuiltinFunctionStringNode_2(std::string id,ExpNode *expression1,ExpNode *expression2): BuiltinFunctionNode(id)
	{
		this->_exp1 = expression1;
		this->_exp2 = expression2;
...
class GetLengthStmt: public Statement 
{
 private:
	ExpNode* _x;
 ...
 public:
/*!		
	\brief Constructor of GetLengthStmt 
	
	\post  A new GetLengthStmt is created with the parameter
*/
  GetLengthStmt(ExpNode* x)
	{
		this->_x=x;
	}

/*!
	\brief   Print the GetLengthStmt
	\return  void
	\sa		 evaluate()
*/
  void print();
...
/*!	
	\brief   Evaluate the GetLengthStmt
	\return  double
	\sa		 print
*/
  void evaluate();
...
{
 private:
  char *_variable; //!< Condicion of the if statement
  ExpNode *_start; //!< Condicion of the if statement
  ExpNode *_finish; //!< Condicion of the if statement
  ExpNode *_step; //!< Condicion of the if statement
  std::list<Statement *>  *_stmt; //!< Statement of the consequent

  public:
/*!		
	\brief Constructor of Single ForStmt (without step)
	\param condition: ExpNode of the condition
	\param statement1: Statement of the consequent
	\post  A new IfStmt is created with the parameters
*/
  ForStmt(char *variable, ExpNode *start, ExpNode *finish, std::list<Statement *> *statement)
	{
...
/*!		
	\brief Constructor of Compound ForStmt (with alternative)
	\param condition: ExpNode of the condition
	\param statement1: Statement of the consequent
	\param statement2: Statement of the alternative
	\post  A new ForStmt is created with the parameters
*/
  ForStmt(char *variable, ExpNode *start, ExpNode *finish, ExpNode *step, std::list<Statement *> *statement)
	{
		this->_variable = variable;
		this->_start=start;
		this->_finish=finish;
