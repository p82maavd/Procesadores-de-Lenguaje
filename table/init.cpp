...
void init(lp::Table &t)
{
 ...
 for (i=0; function_2[i].name.compare("")!=0; i++)
  ...
  lp::BuiltinParameterString1 *f3;

 // The predefined functions with 2 parameters are installed in the table of symbols
 for (i=0; function_3[i].name.compare("")!=0; i++)
	{
		 f3 = new lp::BuiltinParameterString1(function_3[i].name,
									   BUILTIN,   // Token
									   1,		  // Number of parameters
									   function_3[i].function);
 ...
 lp::BuiltinParameterString2 *f4;

 // The predefined functions with 2 parameters are installed in the table of symbols
 for (i=0; function_4[i].name.compare("")!=0; i++)
	{
		 f4 = new lp::BuiltinParameterString2(function_4[i].name,
									   BUILTIN,   // Token
									   2,		  // Number of parameters
									   function_4[i].function);
